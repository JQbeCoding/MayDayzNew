...
customLoginForm.addEventListener("submit", async (event) => {
  ...
  try {
    const response = await fetch("https://maydayzsite.onrender.com/login", {
      method: "POST",
...
otpVerificationForm.addEventListener("submit", async (event) => {
  ...
  try {
    const response = await fetch("https://maydayzsite.onrender.com/verify-otp", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
resendOtpButton.addEventListener("submit", async () => {
  ...
  try {
    ...
    const response = await fetch("https://maydayzsite.onrender.com/login.html", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
